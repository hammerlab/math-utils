...
class DoubleTest
  ...
  sweepTests(
    ...
    ((1,1)||1) →(Stats( 44100, 2.1e-16, 3.6e-16, 1.3e-14 ) js Stats( 44100, 1.8e-16, 3.6e-16, 1.3e-14 )),
    ||(2)      → Stats(   420,       0,       0,       0 ),
  ...
  gaussians(
    ...
    ||(1,1)    →(Stats( 8000, 1.3e-13, 3.3e-12, 1.3e-10 ) js
                 Stats( 8000, 9.6e-14, 2.4e-12, 1.3e-10 ))
  )
