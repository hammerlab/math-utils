...
/**
 * Test the default [[cats.Show.show show]] implementation of [[Stats]].
 */
class ShowTest
  extends Suite {
  ...
  test("values over Int.MAX_VALUE") {
    check(
      ...
      """N: 10, μ/σ: 3.3e11/4.4e11, med/mad: 1e11/9e10
